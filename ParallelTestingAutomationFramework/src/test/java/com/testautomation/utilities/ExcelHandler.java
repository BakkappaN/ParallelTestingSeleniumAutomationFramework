...
public class ExcelHandler {
	...
	public static synchronized Map<String,String> getTestDataInMap(String testDataFile,String sheetName,String testCaseId) throws Exception
	{
		Map<String,String> TestDataInMap=new TreeMap<String,String>();
		 String query=String.format("SELECT * FROM %s WHERE Run_ThisRow='Yes' and TestCaseId='%s'",
	...
	public static synchronized void UpdateTestResultsToExcel(String testDataFilePath, String sheetName,
		...
		try {
			...
			conn.close();
			System.out.println("Updated sheet with " + result + " row");
		} catch (FilloException e) {
			e.printStackTrace();
		}
	}
